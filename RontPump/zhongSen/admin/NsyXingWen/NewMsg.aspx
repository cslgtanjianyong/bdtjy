<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMsg.aspx.cs" Inherits="zhongSen.admin.NsyXingWen.NewMsg" %>
            ...
            <td valign="top" bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="130" class="fontzr15" >新闻管理</td>
                        <td>&nbsp;</td>
                        <td align="right" >
                     &nbsp;&nbsp;<b>标题名称：</b><asp:TextBox ID="txtTitle" runat="server" CssClass="inputTime" MaxLength="50" Height="18">
                     </asp:TextBox>
                          ...
                          <asp:Repeater ID="RepeaterNew"  runat="server">
                                <HeaderTemplate>
                                    ...
                                    <td align="center" width="5%"><b>序号</b></td>
                                     <td  align="center"  width="25%"><b>标题名</b></td>
                                ...
                                <ItemTemplate>
                                    <tr valign="middle" bgcolor="#FFFFFF" height="26" onmouseout="mOut(this,'#Ffffff');" onmouseover="mOvr(this,'#F0F1EF');">
                                        ...
                                        <td align="center"><a href="NsyNewAdd.aspx?id=<%#DataBinder.Eval(Container.DataItem, "ID")%>" >修改</a></td>
