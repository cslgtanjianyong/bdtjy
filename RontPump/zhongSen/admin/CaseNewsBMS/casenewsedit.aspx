<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casenewsedit.aspx.cs" Inherits="zhongSen.admin.CaseNewsBMS.casenewsedit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CasesTypeAddcheck() {
            ...
            if (checkAddIndextxtCName() == true && checkclass() == true) {
...
<body>
    <form id="form1" runat="server">
                ...
                <td valign="top" bgcolor="#FFFFFF">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="130" class="fontzr15">修改产品
                            </td>
                            <td align="right">&nbsp;
                            </td>
                        </tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="97%" align="center" bgcolor="#FBFAF9">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <font color="red">&nbsp;* &nbsp;&nbsp;<asp:Label ID="LbRecUpload" Style="color: green"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <font color="red">&nbsp;* &nbsp;&nbsp;<asp:Label ID="lbl_proimg" Style="color: green"
                                            runat="server" Text=""></asp:Label></font>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left">&nbsp;&nbsp;<asp:Button ID="btnOK" runat="server" Text="修改" class="button" onmouseover="onButton(this);"
        ...
        <script>
            ...
            //var jsctids = new Array();
            //jsctids.unshift("5","11","17");
            //ctid.join(',');

            //$('.cbo').each(function () {
            //    for (var i = 0; i < jsctids.length; i++) {
            //        alert("index" + jsctids[i] + "arr-" + $(this).attr("data-id"));

            //        if ($(this).attr('data-id') == jsctids[i]) {
            //            $(this).addClass('std');
            //            arri = arri + 1;
            //            ctid.splice(arri, 0, $(this).attr('data-id'));
            //        }
            //    }
            //})
        </script>
        ...
        <script type="text/javascript">
            ...
            $(".cbo").click(function () {
                ...
                ctid.join(',');
                //alert(ctid + "\n len" + ctid.length + "\n i:" + arri);
                casenewsedit.StdCaseType(ctid);
            });



            //var stdctids = new Array(); $('.cbo').each(function () { if ($(this).attr('data-id') == '11') { $(this).addClass('std'); } });


            //var stdctids = new Array(); $('.cbo').each(function () { for (var i = 0; i < stdctids.length; i++) { if ($(this).attr('data-id') == stdctids[i]) { $(this).addClass('std'); } } });
        </script>
    </form>
</body>
</html>
